  ...
  e.waitUntil(
    caches.open(cacheName).then(cache => {
      return cache.addAll([
        ...
        '/it202-big/scripts/dictionary.js',
        '/it202-big/scripts/dog.js',
        '/it202-big/scripts/map.js',
        '/it202-big/scripts/script.js',
        '/it202-big/scripts/materialDrawer.js',
        '/it202-big/scripts/semantic.min.js',
        '/it202-big/screen-content/_aboutScreen.html',
        '/it202-big/screen-content/_crimeScreen.html',
        '/it202-big/screen-content/_dictionaryScreen.html',
        '/it202-big/screen-content/_dogScreen.html',
        '/it202-big/screen-content/_homeScreen.html',
        '/it202-big/screen-content/_mapScreen.html',
